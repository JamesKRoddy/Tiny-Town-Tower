...
[CustomPropertyDrawer(typeof(BuildingParents))]
public class BuildingParentsPropertyDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        var buildingParentProp = property.FindPropertyRelative("buildingParent");
        ...
        // Draw preview
        if (buildingParentProp.objectReferenceValue != null)
        {
            var preview = GetPrefabPreview(buildingParentProp.objectReferenceValue as GameObject);
            if (preview != null)
            {
        ...
        // Draw object field
        EditorGUI.ObjectField(objectFieldRect, buildingParentProp, typeof(GameObject), GUIContent.none);
