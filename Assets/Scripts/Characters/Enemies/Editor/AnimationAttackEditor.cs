...
namespace Enemies.Editor
{
    ...
    public class CloseRangeAttackEditor : AttackBaseEditor
    {
        ...
        {
            // Get animation attack specific values
            ...
            float scale = maxVisualRange / Mathf.Max(maxRange, radius, 1f);
            ...
            float visualAttackRadius = radius * scale;
            ...
            GUI.Label(new Rect(labelX, labelY + 24, 120, 12), $"Radius: {radius:F1}m", labelStyle);
